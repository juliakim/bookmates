  ...
  return (
    <div style={{ background: '#fff', padding: 24, minHeight: 400 }}>
      ...
      <List
        ...
        dataSource={parseResults(props.favorites)}
        renderItem={book => (
          <List.Item
            key={book.id}
            actions={[
              <Button type="link" onClick={() => props.removeFromFavorites(book)}>
                <IconText type="delete" text={'Remove from favorites'} key="list-vertical-delete"/>
              </Button>
